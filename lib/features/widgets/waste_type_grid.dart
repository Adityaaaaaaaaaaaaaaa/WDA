...
final List<WasteType> _wasteTypes = [
  ...
  WasteType("Scrap Metal", Icons.build, Colors.grey,
      ...
      difficulty: "Medium",
      rarity: "Uncommon"),
  WasteType("Construction", Icons.construction, Colors.orange,
      points: 120,
      sass: "DIY disaster 🛠️",
  ...
  WasteType("Rubble", Icons.layers, Colors.grey.shade600,
      ...
      difficulty: "Medium",
      rarity: "Uncommon"),
  WasteType("Money", Icons.attach_money_rounded, Colors.green,
      points: 123,
      sass: "Dollar bills \$\$\$",
      description: "My money? Your Money? money money ...",
      difficulty: "easy",
      rarity: "lendary"),
  ...
  WasteType("Foam", Icons.blur_on, Colors.blueGrey.shade200,
      ...
      difficulty: "Annoying",
      rarity: "Common"),
  WasteType("Household", Icons.cleaning_services, Colors.lightBlue.shade700,
      points: 70,
      sass: "Toxic shine 🧴",
