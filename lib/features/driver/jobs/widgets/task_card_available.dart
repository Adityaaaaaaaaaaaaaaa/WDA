...
class TaskCardAvailable extends StatelessWidget {
  ...
  final DriverTasksService? svc; // <- nullable now
          ...
          children: [
            Row(children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(color: Colors.orange.shade100, borderRadius: BorderRadius.circular(10.r)),
                child: Text(
                  task.status == 'completed' ? "Completed" :
                  (task.driverAssigned ? "In Progress" : "Available"),
                  style: TextStyle(fontSize: 11.sp,
                      color: task.status == 'completed'
                          ? Colors.green.shade800
                          : (task.driverAssigned ? Colors.blue.shade800 : Colors.orange.shade800),
            ...
            // Buttons: if svc is null -> hide Accept, show only View
            Row(
              children: [
                Expanded(
